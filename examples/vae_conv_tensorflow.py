...
import numpy as np
import vaelib.mnist_data as mnist_data
import os
import vaelib.vae_con as vae_con
import plot_utils
import glob
...
def main(args):
    ...
    y, z, loss, neg_marginal_likelihood, KL_divergence = vae_con.autoencoder(x_hat, x, dim_img, dim_z, n_hidden, keep_prob)
